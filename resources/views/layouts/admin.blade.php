  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('getBookings')}}"><i class="fa fa-book"></i> <span>Booking</span></a></li>
        <li class="active"><a href="{{route('getUser')}}"><i class="fa fa-user"></i> <span>User</span></a></li>
        <li class="active"><a href="{{route('logoutUser')}}"><i class="fa fa-sign-out"></i> <span>Logout</span></a></li>
        <!--
        <li class="treeview">
